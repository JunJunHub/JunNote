...
# vop绑定核心
####################
/usr # cat /proc/interrupts | grep vop
 57:     153689     545045          0          0          0          0          0          0     GICv3 188 Level     fdd97e00.iommu, fdd90000.vop
/usr #
/usr #
/usr # cat /proc/irq/57/smp_affinity
02
/usr #
/usr #
/usr # echo 2> /proc/irq/57/smp_affinity
...
# 查看驱动统计VSYCN时间间隔信息
#########################################
/bin # cat /sys/kernel/debug/dri/0/video_port0/vs_stat
vp0 vs stat
|- chk_en : 1
|- vs_cnt : 3248857
|- vs_intv: min=16654 max=16683 avg=16666us diff[+/-1000us]=0/0

support follow cmd:
|- stop  check: echo 0    > /sys/kernel/debug/dri/0/video_port0/vs_stat
|- start check: echo 1    > /sys/kernel/debug/dri/0/video_port0/vs_stat
|- reset count: echo 2    > /sys/kernel/debug/dri/0/video_port0/vs_stat
|- set diff_us: echo [us] > /sys/kernel/debug/dri/0/video_port0/vs_stat
